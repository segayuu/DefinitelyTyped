...
declare class Bluebird<R> implements PromiseLike<R>, Bluebird.Inspection<R> {
   ...
   */
  static method<R, A extends any[]>(fn: (...args: A) => Resolvable<R>): (...args: A) => Bluebird<R>;
   ...
   */
  static coroutine<T, N, A extends any[]>(
      generatorFunction: (...args: A) => Generator<Resolvable<N>, Resolvable<T>, N>,
